...
class EventsGeneralItem(scrapy.Item):
    nombre = scrapy.Field()
    ubicacion = scrapy.Field()
    ubicacion_detalle = scrapy.Field()
    ubicacion_referencia = scrapy.Field()
    distrito = scrapy.Field()
    region = scrapy.Field()
    fecha_inicio = scrapy.Field()
    fecha_inicio_alt = scrapy.Field()
    fecha_fin = scrapy.Field()
    descripcion = scrapy.Field()
    precio = scrapy.Field()
    organizador = scrapy.Field()
    asistiran = scrapy.Field()
    me_interesa = scrapy.Field()
    veces_compartido = scrapy.Field()
    imagen = scrapy.Field()
    enlace_evento = scrapy.Field()
